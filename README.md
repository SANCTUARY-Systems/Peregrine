...
```
cd existing_repo
git remote add origin https://sgit.trust.informatik.tu-darmstadt.de:8081/sanctuary/peregrine/Peregrine.git
git branch -M main
...
- [ ] [Set up project integrations](https://sgit.trust.informatik.tu-darmstadt.de:13196/sanctuary/peregrine/Peregrine/-/settings/integrations)
